      ...
      <div className="flex flex-col items-center max-w-4xl mx-auto">
        <header className="px-4 flex justify-between items-center w-full mt-6">
          <div className="flex items-center space-x-2.5">
            ...
            <p className="font-semibold text-stone-500 hidden sm:block">"What's Gas Like?"</p>
          </div>
        ...
        <section className="flex flex-col items-center text-stone-350 bg-stone-700 sm:rounded-xl shadow-md border border-stone-900 border-t-0 w-full sm:max-w-md p-6 sm:px-9 mb-5 ">
        ...
        <section className="text-stone-350 bg-stone-700 sm:rounded-xl shadow-md border border-stone-900 border-t-0 sm:max-w-md w-full p-6  sm:px-9">
          <div className="flex space-x-1.5 items-center text-stone-400 mt-1 mb-6">
          ...
          <div className=" space-y-4 mb-6">
            ...
            <div className="flex justify-between">
              ...
              <div className="price flex flex-col items-end self-start">
                <span className=" text-stone-50">(416) 804-8644</span>
