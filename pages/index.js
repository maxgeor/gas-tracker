export default function Home({ currentPriceData }) {
  ...
  return (
    <div className=" bg-stone-800 text-stone-50 min-h-screen pb-48">
      <div className="flex flex-col items-center max-w-4xl mx-auto">
        <header className="px-4 flex justify-between items-center w-full mt-6">
          <div className="flex items-center space-x-2.5">
            <span className="rounded-full bg-stone-600 h-8 w-8"></span>
            <p className="font-semibold text-stone-300 hidden sm:block">"What's Gas Like?"</p>
          </div>
          <div className="flex items-center">
            <select value="USD" className="shadow-inner py-1 text-xs px-3 rounded-md bg-stone-700 border border-stone-600">USD</select>
            <span className="text-stone-400 font-medium text-sm border-l border-stone-700 ml-4 pl-3.5">Sign in</span>
          </div>
        </header>
        <h3 className="text-stone-400 mt-12 mb-5">Gas prices are...</h3>
        <h1 className="text-6xl sm:text-7xl font-bold mb-14 sm:mb-16"><span className="text-5xl sm:text-6xl mb-2">🤝</span> Normal</h1>
        <h3 className="text-stone-400 mb-12">Gas is <span className="text-stone-50"><b>{currentPriceData.ProposeGasPrice}</b> Gwei</span>.</h3>
        ...
        <section className="flex flex-col items-center text-stone-350 bg-stone-700 sm:rounded-xl shadow-md border border-stone-900 border-t-0 w-full sm:max-w-md p-6 sm:px-9 mb-16 sm:mb-20">
        <div className=" space-y-1 mb-6 w-full">
            <div className="flex justify-between items-center">
              <span className="w-2/3 leading-6">Send ETH</span>
              <div className="price flex self-start text-stone-50">
          ...
          <div className="text-sm divide-y divide-stone-600 w-full">
        ...
        <section className="max-w-sm">
          <label className="flex flex-col items-center">
            <div className="flex items-center mb-3">
              {/* <svg className="text-stone-400 mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg> */}
              <p className="text-stone-400">Get a text when gas is cheap</p>
            </div>
            <div className="flex">
              <input type="text" paceholder="(911) 911-9111" className=" border-r-0 outline-none focus:ring focus:ring-green-600 bg-stone-700 text-stone-400 rounded-l-md py-1.5 px-3 w-full"></input>
